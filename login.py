...
def login(username,password,appId):
    ...
    cookies = {
        'c_sfbm': '234g_00',
        'logHostIP': 'null',
        'route': '4232d57fd59f167782e9f5fc445a478a',
        'channel': 'GGPD',
        'city': '091|940',
        'devicedId': 'EE388131-FAB3-41F8-8263-F9CDAC45C38C',
        'mobileService1': 'BGjtCOIDjjm3a8FbD0KoF0SOt4F3s3BNjeBd3T01LmZv5HMsKOoC!1180849723',
        'mobileServiceAll': '0212ef8e59dab3538a856bc873e51829',
    }
    ...
    data = {
        ...
        'isRemberPwd': 'false',
        'appId': appId,
        'deviceId': '75aa5f3f804cbf4662868f4b9ebbd857df5dd925ce12456068c9104b0663f84a',
        'pip': '192.168.1.10',
        'password': password,
        'deviceOS': '14.4',
        'deviceBrand': 'iphone',
        ...
        'remark4': '',
        'keyVersion': '2',
        'deviceCode': 'EE388131-FAB3-41F8-8263-F9CDAC45C38C'
    }
